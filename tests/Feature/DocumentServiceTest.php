...
describe('handleUpload', function () {
    it('successfully handles file upload', function () {
        ...
        expect($document)->toBeInstanceOf(Document::class)
            ...
            ->and($document->d_name)->toBe('test.pdf')
            ->and($document->d_file_path)->not->toBeEmpty();

        expect(Storage::disk('uploads_temp')->exists($document->d_file_path))->toBeTrue();
...
describe('deleteDocument', function () {
    ...
    it('handles missing file gracefully', function () {
        $document = Document::factory()->create(['d_file_path' => 'missing.pdf']);
