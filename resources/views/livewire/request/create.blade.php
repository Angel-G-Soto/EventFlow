        ...
        {{-- - Ensure the primary submit <button> has type="submit" and discernible text.--}}
            ...
            <x-slot:pageActions>
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="fw-bold nav-link ? 'active' : '' "
            ...
            <div>
                ...
                <ul class="nav nav-pills mb-4 request-step-nav" aria-label="Event creation steps">
                    ...
                    <li class="nav-item"><span class="nav-link {{ $step === 3 ? 'active' : '' }}">3. Documents</span>
                    </li>
                </ul>
                {{-- STEP 1 --}}
                @if ($step === 1)
                ...
                <form wire:submit.prevent="next" data-prevent-enter-submit aria-labelledby="eventRequestStep1Heading">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control js-phone-format"
                                wire:model.defer="creator_phone_number" placeholder="e.g., 787-777-7777">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" wire:model.defer="creator_institutional_number"
                                placeholder="e.g., 802201234">
                            @error('creator_institutional_number') <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="6" maxlength="2000" wire:model.defer="description"
                                placeholder="e.g., Describe the event purpose and highlights"></textarea>
                            <small class="text-muted">Minimum 10 characters, maximum 2,000 characters.</small>
                            @error('description') <div class="text-danger small">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-12">
                            <label class="form-label">Multimedia equipment needed <span
                                    class="text-muted">(Optional)</span></label>
                            <textarea class="form-control" rows="4" maxlength="2000"
                                wire:model.defer="multimedia_equipment"
                                placeholder="List any audio/visual or other multimedia equipment you need ready before the event (e.g., projector, microphones, speakers)."></textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" wire:model.defer="guest_size"
                                placeholder="e.g., 40">
                            @error('guest_size')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control" wire:model.live="start_time"
                                min="{{ now()->format('Y-m-d\\TH:i') }}" placeholder="e.g., 2025-05-15T09:00">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" class="form-control" wire:model.live="end_time"
                                min="{{ now()->format('Y-m-d\\TH:i') }}" placeholder="e.g., 2025-05-15T12:00">
                        ...
                        <div class="col-12">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <button type="button" class="btn btn-link btn-sm p-0 event-form-link-btn"
                                    wire:click="clearCategories" @disabled(empty($category_ids))>
                                    Clear selection
                                </button>
                            </div>
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-text bg-transparent border-0"
                                                    wire:loading.remove wire:target="categorySearchInput">
                        ...
                        <div class="form-check">
                            <input id="handles_food" type="checkbox" class="form-check-input"
                                wire:model.live="handles_food" aria-describedby="handles_food_help">
                        ...
                        <div class="form-check">
                            ...
                            <div id="hasFunds" class="form-text">Choose this if institutional or university funds will
                                cover
                                the request.</div>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="external_guest">This event has an external
                                guest</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="{{ $organization_advisor_name}}" class="form-control"
                                {{--wire:model="organization_advisor_name" --}} disabled
                                placeholder="e.g., Prof. Maria Lopez">
                            @error('organization_advisor_name') <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @error('organization_advisor_email') <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            <label class="form-label required">Advisor Telephone Number</label>
                            <input type="text" class="form-control js-phone-format"
                                wire:model.defer="organization_advisor_phone" placeholder="e.g., 787-555-1234">
                            @error('organization_advisor_phone') <div class="text-danger small">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="card shadow-sm mb-3">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-3 col-lg-2">
                                    ...
                                    <input id="venueCapacityFilter" type="number" min="0" class="form-control"
                                        placeholder="e.g., 50" wire:model.live.debounce.500ms="venueCapacityFilter">
                                </div>
                            ...
                            <div class="form-text mt-3">
                                Filters update automatically as you type. Use Refresh if you need to manually rerun the
                                availability query.
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover align-middle shadow-sm">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th scope="col" style="width:120px">Details</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <nav aria-label="Venues pagination">
                            <ul class="pagination pagination-sm mb-0">
                                ...
                                <li class="page-item {{ $page === $this->venuePagination['current'] ? 'active' : '' }}">
                                    <button type="button" class="page-link" wire:click="goToVenuePage({{ $page }})"
                ...
                <form wire:submit.prevent="submit" data-prevent-enter-submit aria-labelledby="eventRequestStep3Heading">
                    ...
                    <div class="mb-3">
                        <ul>
                            <li>
                                <a href="https://www.uprm.edu/p/actividades-sociales/certificado_de_manejador_de_alimentos"
                                    class="event-form-link-btn" target="_blank" rel="noopener">Food Handling Details</a>
                            </li>
                        </ul>
                    </div>
                    @endif
                    ...
                    <div class="mb-3">
                        <ul>
                            <li>
                                ...
                                <a href="{{ asset('assets/documents/ejemplo_carta_del_rector.pdf') }}"
                                    class="event-form-link-btn" target="_blank" rel="noopener">Institutional Funds
                                    Details</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-3">
                        <ul>
                            <li>
                                {{-- wire:click.prevent="showInstitutionalFundsDetails" --}}
                                <a href="{{ asset('assets/documents/ejemplo_carta_del_rector.pdf') }}"
                                    class="event-form-link-btn" target="_blank" rel="noopener">External Guest Name
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div wire:ignore.self class="modal fade" id="confirmSubmitModal" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                After submission, you will not be able to make further changes. Missing required
                                documents may incur in the dismissal of your request.
                            </div>
                            <div class="modal-footer">
