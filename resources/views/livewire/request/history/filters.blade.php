...
<div class="card-body py-2" style="font-size: 1.05rem;" aria-labelledby="historyFiltersHeading">
    <div class="visually-hidden">
        <h2 id="historyFiltersHeading" class="h6 text-uppercase text-muted mb-0">Filter approval history</h2>
        <p class="mb-0 small text-muted">Adjust the filters and choose Apply to refresh the results.</p>
    </div>
    <div class="row align-items-end g-2">

        {{-- Search by Title --}}
        <div class="col-md-4 col-sm-12">
            <label for="searchTitle" class="form-label mb-0 small text-muted fw-semibold" style="font-size: 1.05rem;">Search approval history</label>
