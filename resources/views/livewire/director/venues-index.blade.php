            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="text-end d-none d-sm-table-cell">Test Capacity</th>
                    </tr>
                    </thead>
                    <tbody>
                    @forelse($venues as $v)
                        <tr>
                            ...
                            <td class="fw-medium text-end d-none d-sm-table-cell">{{ $v['test_capacity'] }}</td>
                        </tr>
                    @empty
                        <tr>
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="d-none d-md-flex">
                <button
                    ...
                    wire:click="$dispatch('open-modal', { id: 'emailModal' })"
