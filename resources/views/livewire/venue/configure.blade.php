...
<div>
    ...
    <div class="py-4">
        <div class="card shadow-sm mb-3">
            ...
            <div class="card-body">
                            ...
                            <tr>
                                <td class="fw-semibold">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="day-{{ $dayId }}">
                                            {{ $day }}
                                        </label>
                                    </div>
                                </td>
                ...
                <div class="form-text">
                    Enable the days the venue can be booked and provide 24-hour times (HH:MM).
        ...
        <div class="card-header">
            <div class="d-flex flex-column flex-xl-row align-items-start align-items-xl-center justify-content-between gap-3">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    {{-- If you want "Clear all" later, re-enable this and hook to confirmClearRequirements --}}
                    {{--
                    <button class="btn btn-danger"
                            type="button"
                            wire:click="confirmClearRequirements"
                            wire:loading.attr="disabled"
            ...
            <div class="vstack gap-3">
                @forelse ($rows as $i => $row)
                    ...
                    <div class="card border-0 shadow-sm" wire:key="req-{{ $rowUuid }}">
                            ...
                            <div class="d-flex flex-wrap align-items-center gap-2">
                                ...
                                @else
                                    <span class="text-muted small">
                                        Draft only. Don't forget to save.
                                    </span>
                                @endif
                            </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="req-name-{{ $rowUuid }}" class="form-label">
                                    Requirement title <span class="text-danger">*</span>
                                </label>
                                <input id="req-name-{{ $rowUuid }}"
                                       type="text"
                            ...
                            <div class="mb-3">
                                <label for="req-description-{{ $rowUuid }}" class="form-label">
                                    Guidance or checklist
                                </label>
                                <textarea id="req-description-{{ $rowUuid }}"
                                          rows="3"
                            ...
                            <div class="mb-2">
                                <label for="req-link-{{ $rowUuid }}" class="form-label">
                                    Document link (URL)
                                </label>
                                ...
                                @enderror
                                <div class="form-text">
                                    Attach a policy PDF, web page, or shared doc the
                                    requester must review.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <p class="text-muted small mb-0">
                    ...
                    All updates are saved to the venue after you provide justification
    ...
    {{-- Confirmation modal for deleting requirements --}}
    <div class="modal fade"
         id="requirementsConfirm"
         tabindex="-1"
         aria-hidden="true"
         aria-labelledby="requirementsConfirmLabel"
         wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="mb-0">
                        {{ $confirmDeleteMessage ?: 'Are you sure you want to continue?' }}
                    </p>
                </div>
    ...
    {{-- Shared justification modal (wired to submitJustification in the component) --}}
    <x-justification
        id="sharedJustification"
