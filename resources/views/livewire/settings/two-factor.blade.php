    ...
    <x-settings.layout :heading="__('Two Factor Authentication')"
        ...
        <div class="flex flex-col w-full mx-auto space-y-6 text-sm" wire:cloak>
            ...
            <div class="space-y-4">
                ...
                <flux:text>
                    {{ __('With two-factor authentication enabled, you will be prompted for a secure, random pin during
            ...
            <div class="space-y-4">
                ...
                <flux:text variant="subtle">
                    {{ __('When you enable two-factor authentication, you will be prompted for a secure pin during
